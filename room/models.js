...
export const NEED_GB = { "qwen3-0.6b-q4": 0.6, "qwen3-0.6b-q4k": 0.9, "qwen3-0.6b": 0.8, "qwen3-1.7b": 2.0, "qwen3-4b": 4.6, "llama3-8b-q4": 5.2, "qwen3.8-27b": 16.5, "smollm-135m": 0.6 };
...
export const MODELS = {
  ...
  // First non-Qwen architecture proof for FIELD STATION. Original Llama 3 has the
